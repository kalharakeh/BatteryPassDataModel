...
public sealed class DataCompletionPolicyService
{
    ...
    private static IReadOnlyList<DataRequirementSection> BuildDefaultSections()
    {
        ...
        sections.Add(Section("general", "General", 10,
            ...
            Field("general.product", "Battery Family", "app.product.productId", "Battery Family selected for this passport.", true, 25),
            Field("general.productVersion", "Battery version", "app.product.productVersion", "Battery version selected for this passport.", true, 26),
            Field("general.softwareVersion", "Software version", "app.product.softwareVersion", "Software version selected for this battery version.", true, 27),
