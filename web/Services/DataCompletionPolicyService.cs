...
public sealed class DataCompletionPolicyService
{
    ...
    private static IReadOnlyList<DataRequirementSection> BuildDefaultSections()
    {
        ...
        sections.Add(Section("general", "General", 10,
            ...
            Field("general.productVersion", "Battery Model", "app.product.productVersion", "Battery Model selected for this passport.", true, 26),
            Field("general.softwareVersion", "Software version", "app.product.softwareVersion", "Software version selected for this Battery Model.", true, 27),
