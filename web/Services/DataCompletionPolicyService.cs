...
public sealed class DataCompletionPolicyService
{
    ...
    private static IReadOnlyList<DataRequirementSection> BuildDefaultSections()
    {
        ...
        sections.Add(Section("general", "General", 10,
            ...
            Field("general.productVersion", "Product/battery version", "app.product.productVersion", "Product/battery version selected for this passport.", true, 26),
            Field("general.softwareVersion", "Software version", "app.product.softwareVersion", "Software version selected for this product.", true, 27),
